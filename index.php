		...
		<div class="flex-direction-column col-12">
			...
			<div class="col-9 col-md-12">
				<p class="condensed">
					...
					inquérito.
					<br><br>
					<b>Até agora, recebemos <span class="text-yellow-light">
							<?= $result["numero"] ?> </span> respostas. Obrigado!</b>
				</p>
	...
	<section data-sectionid="section-3" id="section-3" class="slide container flex flex-center">
		...
		<div class="flex-direction-column col-12 rel">
			...
			<div class="graphs">
				...
				<div data-graph="1" data-sectiontitle="A amostra" data-graphcolor="var(--red)" class="flex flex-baseline flex-md-wrap col-12  flex-md-wrap graph current ">
					<div class="col-6 col-md-12">
						<div id="q1-2">
						</div>
					</div>
					<div class="col-6 col-md-12 d-sm-none">
						<h2 class="uppercase">Género e Idade</h2>
						<p>
							Este gráfico tem como objectivo cruzar duas variáveis, nomeadamente a variável género que faz a distinção entre
							o sexo feminino e o sexo masculino, e a variável idade que agrupa a amostra consoante a idade correspondente. A
							relação entre as duas variáveis é apresentada da seguinte forma: o tamanho dos círculos é proporcional ao número
							de respostas, ou seja, quanto mais pessoas de uma idade responderem, maior será o círculo dessa idade.
						</p>
					</div>
				</div>

				<!-- CONTENT 02 -->
				<div data-graph="2" data-sectiontitle="A amostra" data-graphcolor="var(--yellow)" class="flex flex-baseline col-12 flex-md-wrap   graph">
					<div class="col-6 col-md-12">
					...
					<div class="col-6 col-md-12 d-sm-none">
						...
						<p>
							Este gráfico ajuda-nos a conhecer um pouco melhor a amostra, ao analisar conseguimos perceber rapidamente em
							qual dos cursos conseguimos um maior número de respostas. Estes dados são importantes para conseguirmos analisar
							e relacionar os resultados obtidos.
						</p>
					</div>
				</div>

				<!-- CONTENT 03 -->
				<div data-graph="3" data-sectiontitle="Porquê a ESCS?" data-graphcolor="var(--light-blue)" class="flex flex-baseline col-12 flex-md-wrap  graph">
					<div class="col-6 col-md-12">
						<div class="graph-wrapper">
							<canvas id="q4"></canvas>
						</div>
					...
					<div class="col-6 col-md-12 d-sm-none">
						...
						<p>
							Após apurarmos a quantidade de alunos de cada curso que representam a nossa amostra, quisemos saber o motivo
							pela qual o escolheram. A informação recolhida é apresentada no gráfico da seguinte forma: quanto mais o ponto
							correspondente à opção se aproxima da mesma e se afasta do centro, maior é o número de vezes que essa opção foi
							escolhida.
				...
				<!-- CONTENT 04 -->
				<div data-graph="4" data-sectiontitle="Porquê a ESCS?" data-graphcolor="var(--yellow)" class="flex flex-baseline col-12 flex-md-wrap  graph">
					<div class="col-6 col-md-12">
						<div class="graph-wrapper">
							<canvas id="q5"></canvas>
						</div>
					...
					<div class="col-6 col-md-12 d-sm-none">
						...
						<p>
							Porquê a ESCS? É a pergunta para a qual procuramos a resposta e o motivo do questionário apresentado. Por isso
							pedimos para nos responderem escolhendo as opções que se enquadrarem na sua realidade. A informação recolhida no
							gráfico é apresentada da seguinte forma: Quanto mais a “fatia” correspondente à opção se aproxima da extremidade
							do raio da circunferência, maior é o número de vezes que essa opção foi escolhida.
						</p>
					</div>
				</div>

				<!-- CONTENT 04 -->
				<div data-graph="5" data-sectiontitle="Porquê a ESCS?" data-graphcolor="var(--light-blue)" class="flex flex-baseline col-12  flex-md-wrap  graph">
					<div class="col-6">
						<div class="graph-wrapper">
							<canvas id="q6"></canvas>
						</div>
					...
					<div class="col-6 col-md-12 d-sm-none">
						...
						<p>
							Por fim, pedimos para indicar as 3 características que deverão ser mais privilegiadas na ESCS para apurar aquilo
							que para os alunos é mais importante. A informação recolhida no gráfico é apresentada da seguinte forma: A cada
							cor corresponde uma das opções de escolha, o tamanho de cada parte preenchida por essa cor corresponde ao número
							de vezes que essa opção foi selecionada, quanto maior for a quantidade de cor, maior é o número de escolhas
							dessa opção.
						</p>
					</div>
				</div>
